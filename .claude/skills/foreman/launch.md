...
5. **Owner decisions parked**: drop tel link from desktop bar? breadcrumbs at 15 pages? dark mode (cheap with the oklch tokens)? directional back/forward slide transitions (~10 lines of JS in menu.js + a few CSS lines — research done 2026-08-20)?
